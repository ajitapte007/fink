...
METRICS_REGISTRY = [
    # ── Aggregates ─────────────────────────────────────────────────────────────
    {"id": "price",                   "label": "Stock Price",         "description": "Monthly closing stock price",                    "unit": "USD",  "category": "Aggregates",              "defaultAxis": "y",  "isAggregate": False, "color": "#3b82f6"},
    {"id": "revenue",                 "label": "Revenue",             "description": "Total revenue, TTM-aligned",                     "unit": "USD",  "category": "Aggregates",              "defaultAxis": "y",  "isAggregate": True,  "color": "#ec4899"},
    ...
    {"id": "net_income",              "label": "Net Income",          "description": "Net income after taxes",                         "unit": "USD",  "category": "Aggregates",              "defaultAxis": "y",  "isAggregate": True,  "color": "#6366f1"},
    ...
    {"id": "operating_margin", "label": "Operating Margin (%)",  "description": "Operating income as percentage of revenue", "unit": "percent", "category": "Performance & Efficiency", "defaultAxis": "y1", "isAggregate": False, "color": "#3b82f6"},
    ...
    # ── 10-K Revenue Segments ──────────────────────────────────────────────────
    {"id": "product_segments",    "label": "Product Segments",    "description": "Revenue breakdown by product/business line from 10-K", "unit": "USD", "category": "10-K Segments", "defaultAxis": "y", "isAggregate": True, "color": "#0ea5e9", "chartType": "stackedBar"},
    {"id": "geographic_segments", "label": "Geographic Segments", "description": "Revenue breakdown by geography from 10-K",            "unit": "USD", "category": "10-K Segments", "defaultAxis": "y", "isAggregate": True, "color": "#8b5cf6", "chartType": "stackedBar"},
]
