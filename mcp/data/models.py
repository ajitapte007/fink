...
class ChartDataPoint(BaseModel):
    ...
    product_segments: Optional[dict] = Field(None, description="Product segment name to annual revenue USD")
    geographic_segments: Optional[dict] = Field(None, description="Geographic segment name to annual revenue USD")
