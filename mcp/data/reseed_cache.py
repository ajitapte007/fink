...
Good entries are never touched, so this costs the minimum number of API calls.
    ...
    python mcp/data/reseed_cache.py                 # dry run, shows the plan
    python mcp/data/reseed_cache.py --apply         # fetch and write
    python mcp/data/reseed_cache.py --apply --budget 6
...
from data.fetch_utils import (CACHE_DIR, FUNCTIONS, fetch_data,  # noqa: E402
                              is_data_corrupt)
